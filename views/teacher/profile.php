...
$initials  = strtoupper(substr($user['name'] ?? 'T', 0, 1));
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="content-card" style="margin-bottom:2rem;">
                ...
                <div class="avatar-upload-section">
                    ...
                    <div class="avatar-upload-info">
                        ...
                        <p class="avatar-role">Teacher<?= $user['department'] ? ' · ' . htmlspecialchars($user['department']) : '' ?></p>
            ...
            <div class="content-card" style="margin-bottom:2rem;">
                ...
                <form id="profileForm" onsubmit="saveProfile(event)">
                    <div class="setting-section">
                        ...
                        <label class="setting-label">Office Location</label>
                        <input type="text" class="setting-input" id="officeLocation" value="<?= htmlspecialchars($user['office_location'] ?? '') ?>" placeholder="e.g. Room 201, Building A">
                        <label class="setting-label">Office Hours</label>
                        <input type="text" class="setting-input" id="officeHours" value="<?= htmlspecialchars($user['office_hours'] ?? '') ?>" placeholder="e.g. MWF 8:00–10:00 AM">
...
<button type="button" class="pw-eye-btn" onclick="togglePass('confirmPassword', this)" aria-label="Show password" tabindex="-1"><svg id="eye-confirmPassword" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" width="18" height="18"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg></button></div>
    ...
    async function saveProfile(e) {
        ...
        const res    = await fetch('../../api/teacher/update_profile.php', { method: 'POST', headers: {'Content-Type':'application/json'}, body: JSON.stringify(data) });
    ...
    async function changePassword(e) {
        ...
        const res  = await fetch('../../api/teacher/change_password.php', { method: 'POST', headers: {'Content-Type':'application/json'}, body: JSON.stringify(data) });
        const result = await res.json();
