...
switch ($user['role']) {
    case 'student':   $redirect = 'views/student/dashboard.php';   break;
    case 'teacher':   $redirect = 'views/teacher/dashboard.php';   break;
    case 'registrar': $redirect = 'views/registrar/dashboard.php'; break;
    case 'admin':     $redirect = 'views/admin/dashboard.php';     break;
    case 'hr':        $redirect = 'views/hr/dashboard.php';        break;
}
