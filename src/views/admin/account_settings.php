        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-section">
                    ...
                    <a href="account_settings.php" class="nav-item active"><span class="nav-icon">👤</span><span>Profile Settings</span></a>
                ...
                <div class="avatar-upload-section">
                    ...
                    <div class="avatar-upload-info">
                        ...
                        <div class="avatar-actions">
                            ...
                            <?php if ($avatarUrl): ?>
                                <button class="btn btn-secondary" onclick="removeAvatar()">🗑️ Remove</button>
                            <?php else: ?>
                                <button class="btn btn-secondary" onclick="removeAvatar()" id="removeBtn" style="display:none;">🗑️ Remove</button>
                            <?php endif; ?>
                        </div>
...
<button type="button" class="pw-eye-btn" onclick="togglePass('confirmPassword', this)" aria-label="Show password" tabindex="-1"><svg id="eye-confirmPassword" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" width="18" height="18"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg></button></div>
            ...
            <div class="content-card" data-theme-picker-card>
                <div class="card-header">
    ...
    async function uploadAvatar(input) {
        ...
        try {
            ...
            if (data.success) {
                ...
                preview.innerHTML = `<img src="${data.avatar_url}?t=${Date.now()}" alt="Profile" id="avatarImg">`;
                document.getElementById('removeBtn') && (document.getElementById('removeBtn').style.display = '');
    ...
    async function removeAvatar() {
        ...
        if (data.success) {
            ...
            document.getElementById('avatarPreview').innerHTML = `<span class="avatar-initials" id="avatarInitials">${initials}</span>`;
            document.getElementById('removeBtn') && (document.getElementById('removeBtn').style.display = 'none');
    ...
    async function saveProfile(e) {
        ...
        const res  = await fetch('../../api/admin/admin_update_profile.php', { method: 'POST', headers: {'Content-Type':'application/json'}, body: JSON.stringify(data) });
    ...
    async function changePassword(e) {
        ...
        const res  = await fetch('../../api/admin/admin_change_password.php', { method: 'POST', headers: {'Content-Type':'application/json'}, body: JSON.stringify(data) });
        const result = await res.json();
