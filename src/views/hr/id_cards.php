...
function buildCard(emp, side='front') {
    ...
    // Logo
    const logoContent = `<img src="../../../public/images/logo.png" alt="Logo" onerror="this.style.display='none';this.parentNode.innerHTML='OL';">`;
    ...
    if (side === 'front') {
        ...
        <div class="card-back">
            ...
            <div class="card-back-top">
                <div class="back-logo"><img src="../../../public/images/logo.png" alt="Logo" onerror="this.style.display='none';this.parentNode.innerHTML='SCC';"></div>
